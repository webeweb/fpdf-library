...
class PDF_Ref extends FPDF {
    ...
    var $ChangePage = false;    //Flag indicating that the index is being processed

    var $NbCol;   //Flag indicating that a page break has occurred

    var $RefActive = false;  //Array containing the references

    var $Reference = [];              //Current column number

    var $col = 0;              //Total number of columns
