...
class PDF_Tree extends FPDF {
    ...
    function MakeTree($data, $x = 0, $nodeFormat = '+%k', $childFormat = '-%k: %v', $w = 20, $h = 5, $border = 1, $fill = false, $align = '', $indent = 1, $vspacing = 1, $drawlines = true, $level = 0, $hcell = [], $treeHeight = 0.00) {
        if (is_array($data)) {
