...
class PDF_WriteTag extends FPDF {
    ...
    var $Delta; // Maximum width of the line

        var $Indent; // Height of the line

    var $Line2Print; // Text to display

    var $LineLength;

    var $NextLineBegin; // Justification of the text
...
var $Text;
    ...
    var $Xini; // Minimum space between words

var $align;

        var $bPadding; // Line to display

        var $border; // Buffer between lines

    var $fill;

    var $hLine; // Maximum width minus width

var $href;

    var $lPadding;

    var $nbSpace; // Width minus paddings

        var $rPadding; // Number of spaces in the line

        var $tPadding; // Initial position

    var $wLine; // Current URL

    var $wTextLine; // URL for a cell
