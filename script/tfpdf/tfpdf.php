...
var $AliasNbPages;
    ...
    var $AutoPageBreak;               // current page number

    var $ColorFlag;                  // current object number

    var $CoreFonts;            // array of object offsets

    var $CurOrientation;             // buffer holding in-memory PDF

    var $CurPageSize;              // array containing pages

    var $CurrentFont;              // current document state

    var $DefOrientation;           // compression flag

    var $DefPageSize;                  // scale factor (number of points in user unit)

    var $DrawColor;     // default orientation

    var $FillColor;     // current orientation

    var $FontFamily;       // standard page sizes

    var $FontFiles;        // default page size

    var $FontSize;        // current page size

    var $FontSizePt;          // used for pages with non default sizes or orientations

    var $FontStyle;          // dimensions of current page in points

    var $InFooter;              // dimensions of current page in user unit

    var $InHeader;            // left margin

    var $LayoutMode;            // top margin

    var $LineWidth;            // right margin

    var $PDFVersion;            // page break margin

    var $PageBreakTrigger;            // cell margin

    var $PageLinks;              // current position in user unit

    var $PageSizes;              // height of last printed cell

    var $StdPageSizes;          // line width in user unit

    var $TextColor;           // path containing fonts

    var $ZoomMode;          // array of core font names

    var $author;              // array of used fonts

    var $bMargin;          // array of font files

    var $buffer;              // array of encoding differences

    var $cMargin;         // current font family

    var $compress;          // current font style

    var $creator;          // underlining flag

    var $diffs;        // current font info

    var $fontpath;         // current font size in points

    var $fonts;           // current font size in user unit

    var $images;          // commands for drawing color

    var $k;          // commands for filling color

    var $keywords;          // commands for text color

    var $lMargin;          // indicates whether fill and text colors are different

    var $lasth;                 // word spacing

    var $links;             // array of used images

    var $n;          // array of links in pages

    var $offsets;              // array of internal links

    var $page;      // automatic page breaking

    var $pages;   // threshold used to trigger page breaks

    var $rMargin;           // flag set when processing header

    var $state;           // flag set when processing footer

    var $subject;           // zoom display mode

    var $tMargin;         // layout display mode

    var $title;              // title

    var $underline;            // subject

        var $unifontSubset;             // author

    var $w, $h;           // keywords

    var $wPt, $hPt;            // creator

    var $ws;       // alias for total number of pages

    var $x, $y;         // PDF version number
