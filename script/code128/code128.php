...
class PDF_Code128 extends FPDF {
    ...
    protected $ABCset = "";                                         // Tableau des codes 128

    protected $Aset = "";                                  // jeu des caract�res �ligibles au C128

    protected $Bset = "";                                    // Set A du jeu des caract�res �ligibles

    protected $Cset = "";                                    // Set B du jeu des caract�res �ligibles

    protected $JStart = ["A" => 103, "B" => 104, "C" => 105];                                    // Set C du jeu des caract�res �ligibles

    protected $JSwap = ["A" => 101, "B" => 100, "C" => 99];                                      // Convertisseur source des jeux vers le tableau

    protected $SetFrom;                                        // Convertisseur destination des jeux vers le tableau

    protected $SetTo; // Caract�res de s�lection de jeu au d�but du C128

    protected $T128;   // Caract�res de changement de jeu
...
//____________________________ Extension du constructeur _______________________
    ...
    function __construct($orientation = 'P', $unit = 'mm', $format = 'A4') {
        ...
        $this->T128[] = [2, 1, 2, 2, 2, 2];           //0 : [ ]               // composition des caract�res
