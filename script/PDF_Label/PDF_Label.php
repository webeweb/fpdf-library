...
class PDF_Label extends FPDF {
    ...
    protected $_COUNTX;            // Top margin of labels

    protected $_COUNTY;            // Horizontal space between 2 labels

    protected $_Height;            // Vertical space between 2 labels

    protected $_Line_Height;            // Number of labels horizontally

    protected $_Margin_Left;            // Number of labels vertically

    protected $_Margin_Top;                // Width of label

    protected $_Metric_Doc;                // Height of label

    protected $_Padding;        // Line height

    protected $_Width;            // Padding

    protected $_X_Number;            // Type of metric for the document

    protected $_X_Space;                // Current x position

    protected $_Y_Number;                // Current y position
