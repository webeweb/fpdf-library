...
class FPDF_Protection extends FPDF {
    ...
    var $Ovalue;  //whether document is protected

    var $Pvalue;             //U entry in pdf document

    var $Uvalue;             //O entry in pdf document

    var $enc_obj_id;             //P entry in pdf document

    var $encrypted = false;         //encryption object id
